...
const {
  validateTargetsPost,
  validateTargetsPut,
} = require("../middlewares/validators/validatorTargets");
...
// POST
targetsRouter.post("/", checkJwt, validateTargetsPost, (req, res) => {
...
// PUT
targetsRouter.put("/:id", checkJwt, validateTargetsPut, async (req, res) => {
  const { id } = req.params;
